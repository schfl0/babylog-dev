...
export default function NapAllItem({ log: nap, isEdit, setIsEdit }) {
  ...
  return (
    <div
      className={`md:text-2xs text-3xs hover:shadow-sm ${isEdit === nap.id ? "my-1 rounded-md border border-gray-200 p-2" : ""}`}
    >
