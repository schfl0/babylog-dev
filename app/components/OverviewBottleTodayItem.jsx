...
export default function OverviewBottleTodayItem({
  log: bottle,
  isEdit,
  setIsEdit,
}) {
  ...
  return (
    <div
      className={`text-2xs hover:shadow-sm md:text-xs ${isEdit === bottle.id ? "my-1 rounded-md border border-gray-200 p-2" : ""}`}
    >
