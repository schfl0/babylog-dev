...
export default function PoopAllItem({ log: poop, isEdit, setIsEdit }) {
  ...
  return (
    <div
      className={`md:text-2xs text-3xs hover:shadow-sm ${isEdit === poop.id ? "my-1 rounded-md border border-gray-200 p-2" : ""}`}
    >
