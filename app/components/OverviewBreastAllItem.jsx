...
export default function OverviewBreastAllItem({
  log: breast,
  isEdit,
  setIsEdit,
}) {
  ...
  return (
    <div
      className={`text-3xs md:text-3xs hover:shadow-sm ${isEdit === breast.id ? "my-1 rounded-md border border-gray-200 p-2" : ""}`}
    >
